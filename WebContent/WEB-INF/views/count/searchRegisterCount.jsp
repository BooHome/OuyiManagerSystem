...
<form class="form-inline definewidth m20" action="searchregister" method="get">
    ...
    <div style="position: relative;top: 10px;left: 30px;">
	 ...
	 <div style="float:right">
		 <nav>
			<ul class="pager">
				<li><a href="searchregister?pageNum=1&startTime=${searchR['startTime']}
				&endTime=${searchR['endTime']}&keyName=${searchR['pTitle']}&pcId=${searchR['pcId']}">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage}">
					<li><a href="searchregister?pageNum=${pageInfo.pageNum-1}&startTime=${searchR['startTime']}
				&endTime=${searchR['endTime']}&keyName=${searchR['pTitle']}&pcId=${searchR['pcId']}" aria-label="Previous"> <span
						aria-hidden="true">上一页</span>
				</a></li>
				</c:if>
				<c:if test="${pageInfo.hasNextPage}">
					<li><a href="searchregister?pageNum=${pageInfo.pageNum+1}&startTime=${searchR['startTime']}
				&endTime=${searchR['endTime']}&keyName=${searchR['pTitle']}&pcId=${searchR['pcId']}" aria-label="Next"> 
					<span aria-hidden="true">下一页</span>
				</a></li>
				</c:if>
				<li><a href="searchregister?pageNum=${pageInfo.pages}&startTime=${searchR['startTime']}
				&endTime=${searchR['endTime']}&keyName=${searchR['pTitle']}&pcId=${searchR['pcId']}">尾页</a></li>
				<li>
					<form action="searchregister" method="get" style="float:right">
					   ...
					   <input  type="hidden" name="endTime" id="endTime" 	 value="${searchR['endTime']}" >
						<input type="hidden" name="keyName" id="keyName" value="${searchR['pTitle']}">
						<input type="hidden" name="pcId" id="pcId" value="${searchR['pcId']}" >
