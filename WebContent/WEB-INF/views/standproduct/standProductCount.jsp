...
<form class="form-inline definewidth m20" action="searchStandProduct" method="get">
    ...
    <div style="position: relative;top: 10px;left: 30px;">
	 ...
	 <div style="float:right">
		 <nav>
			<ul class="pager">
				<li><a href="standProductCount?pageNum=1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage}">
					<li><a href="standProductCount?pageNum=${pageInfo.pageNum-1}" aria-label="Previous"> <span
						aria-hidden="true">上一页</span>
				</a></li>
				</c:if>
				<c:if test="${pageInfo.hasNextPage}">
					<li><a href="standProductCount?pageNum=${pageInfo.pageNum+1}" aria-label="Next"> 
					<span aria-hidden="true">下一页</span>
				</a></li>
				</c:if>
				<li><a href="standProductCount?pageNum=${pageInfo.pages}">尾页</a></li>
				<li>
					<form action="standProductCount" method="get" style="float:right">
